...
// src/app/features/course/courses-service/courses.service.spec.ts
init_testing();
...
var HttpClientTestingBackend = class _HttpClientTestingBackend {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: _HttpClientTestingBackend, deps: [], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: _HttpClientTestingBackend });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: HttpClientTestingBackend, decorators: [{
  type: Injectable
}] });
...
var HttpClientTestingModule = class _HttpClientTestingModule {
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: _HttpClientTestingModule, deps: [], target: FactoryTarget.NgModule });
  static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.4", ngImport: core_exports, type: _HttpClientTestingModule, imports: [HttpClientModule] });
  static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: _HttpClientTestingModule, providers: [provideHttpClientTesting()], imports: [HttpClientModule] });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.4", ngImport: core_exports, type: HttpClientTestingModule, decorators: [{
  type: NgModule,
  args: [{
...
describe("CoursesService", () => {
  let service;
  let httpMock;
  const newCourse = { id: 0, title: "Turbo Pascal", description: "Lo mejor del MSDOS programaci\xF3n avanzada" };
  const updateData = { id: 2, title: "Fox Pro 6.0", description: "Curso avanzado de FP" };
  const updatedCourse = { id: 2, title: "Fox Pro 6.0", description: "Curso avanzado de FP para" };
  const deletedCourse = { id: 1, title: "Visual Basic 6.0", description: "Primeros pasos en vb6" };
  const mockUsers = [
  ...
  fit("Deber\xEDa CREATE Courses (POST)", () => {
    const createdCourse = __spreadValues({}, newCourse);
  ...
  fit("Deber\xEDa UPDATE Courses (PUT)", () => {
  ...
  fit("Deber\xEDa DELETE Courses (DELETE)", () => {
    const courseId = 1;
...
@angular/common/fesm2022/http/testing.mjs:
   ...
   *)
*/
//# sourceMappingURL=spec-courses.service.spec.js.map
